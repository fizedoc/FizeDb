...
|属性         |值                                  |
+=============+====================================+
|命名空间     |fize\\db\\realization\\sqlite\\mode |
+-------------+------------------------------------+
|类名         |Sqlite3                             |
+-------------+------------------------------------+
|父类         |fize\\db\\realization\\sqlite\\Db   |
+-------------+------------------------------------+
...
.. code-block:: php
  ...
  public function prototype () : \SQLite3
...
:参数:
  ...
  |名称   |说明                                                                      |
  +=======+==========================================================================+
  |name   |应该返回ID的那个序列对象的名称,该参数在sqlite3中无效                      |
  +-------+--------------------------------------------------------------------------+
