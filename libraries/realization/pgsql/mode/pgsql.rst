...
.. code-block:: php
  ...
  public function prototype () : \fize\db\realization\pgsql\mode\driver\Pgsql
...
:参数:
  ...
  |名称   |说明                                                                               |
  +=======+===================================================================================+
  |name   |应该返回ID的那个序列对象的名称,该参数在PostgreSQL中必须指定                        |
  +-------+-----------------------------------------------------------------------------------+
